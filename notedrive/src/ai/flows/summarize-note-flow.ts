...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert summarization tool. Your task is to provide a concise and accurate summary of the given note content. Focus on extracting the main points and key information.
